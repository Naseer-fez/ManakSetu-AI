...
start "BIS-SpecAI Backend (Port 8000) [Mac Distributed]" cmd /k "cd /d "%ROOT_DIR%" && call "%VENV_DIR%\Scripts\activate.bat" && set "MAC_AVAILABLE=true" && set "MAC_ENDPOINT=http://10.193.109.94:5008/reason" && python run_all.py || pause"
