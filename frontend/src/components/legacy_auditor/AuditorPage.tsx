...
import { analyzeTender } from '../../legacy_services/tender.service';
import type { TenderAnalysisReport } from '../../legacy_types';
import { LoadingState } from '../legacy_primitives/LoadingState';
import { ErrorState } from '../legacy_primitives/ErrorState';
...
export const AuditorPage: FC<AuditorPageProps> = ({ onNavigate, onSetPdfText }) => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-canvas p-6 flex flex-col">
      {!report ? (
