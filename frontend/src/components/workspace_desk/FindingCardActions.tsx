  ...
  return (
    <div className="flex items-center justify-between pt-2 border-t border-gov-border/60 dark:border-slate-800 text-xs">
      <div className="flex items-center gap-1.5">
        {isResolved ? (
          <button
            ...
            className="px-2.5 py-1 rounded bg-gov-offwhite dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 text-gov-text-secondary dark:text-gray-300 border border-gov-border dark:border-slate-700 flex items-center gap-1 text-[11px]"
          ...
          <>
            ...
            <button
              ...
              className="px-2.5 py-1 rounded bg-gov-offwhite hover:bg-gray-100 dark:bg-slate-800/60 dark:hover:bg-slate-700 text-gov-text-secondary dark:text-gray-400 border border-gov-border dark:border-slate-700 flex items-center gap-1 text-[11px] transition-colors"
            >
      ...
      <button
        ...
        className="px-2.5 py-1 rounded bg-blue-50 hover:bg-blue-100 dark:bg-blue-950/40 dark:hover:bg-blue-900/50 text-gov-blue dark:text-blue-300 border border-blue-200 dark:border-blue-900/50 flex items-center gap-1 text-[11px] font-medium transition-colors"
